...
int _userEstimateSize(
  ...
  bytesCount += 3 + object.userIdServer.length * 3;
...
void _userSerialize(
  ...
  writer.writeString(offsets[3], object.userIdServer);
...
User _userDeserialize(
  ...
  object.userIdServer = reader.readString(offsets[3]);
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> userIdServerEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'userIdServer',
        value: value,
        caseSensitive: caseSensitive,
      ));
    });
  ...
  QueryBuilder<User, User, QAfterFilterCondition> userIdServerGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> userIdServerLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> userIdServerBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<User, User, QAfterFilterCondition> userIdServerStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> userIdServerEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> userIdServerContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<User, User, QAfterFilterCondition> userIdServerMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<User, User, QAfterFilterCondition> userIdServerIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'userIdServer',
        value: '',
  ...
  QueryBuilder<User, User, QAfterFilterCondition> userIdServerIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'userIdServer',
        value: '',
...
extension UserQuerySortBy on QueryBuilder<User, User, QSortBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> sortByUserIdServer() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userIdServer', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByUserIdServerDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userIdServer', Sort.desc);
    });
  }
...
extension UserQuerySortThenBy on QueryBuilder<User, User, QSortThenBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> thenByUserIdServer() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userIdServer', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByUserIdServerDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userIdServer', Sort.desc);
    });
  }
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  ...
  QueryBuilder<User, User, QDistinct> distinctByUserIdServer(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'userIdServer', caseSensitive: caseSensitive);
    });
  }
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, String, QQueryOperations> userIdServerProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'userIdServer');
    });
  }
