...
extension SubtaskQuerySortBy on QueryBuilder<Subtask, Subtask, QSortBy> {
  QueryBuilder<Subtask, Subtask, QAfterSortBy> sortByIsCompleted() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCompleted', Sort.asc);
    });
  }

  QueryBuilder<Subtask, Subtask, QAfterSortBy> sortByIsCompletedDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SubtaskQuerySortThenBy
  ...
  QueryBuilder<Subtask, Subtask, QAfterSortBy> thenByIsCompleted() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCompleted', Sort.asc);
    });
  }

  QueryBuilder<Subtask, Subtask, QAfterSortBy> thenByIsCompletedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCompleted', Sort.desc);
    });
  }
...
extension SubtaskQueryWhereDistinct
  ...
  QueryBuilder<Subtask, Subtask, QDistinct> distinctByIsCompleted() {
    return QueryBuilder.apply(this, (query) {
...
extension SubtaskQueryProperty
  ...
  QueryBuilder<Subtask, bool, QQueryOperations> isCompletedProperty() {
    return QueryBuilder.apply(this, (query) {
